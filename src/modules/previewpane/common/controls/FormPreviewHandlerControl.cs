...
namespace Common
{
    ...
    /// </summary>
    public abstract class FormPreviewHandlerControl : Form, IPreviewHandlerControl
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FormPreviewHandlerControl"/> class.
        /// </summary>
        public FormPreviewHandlerControl()
        {
        ...
        /// <inheritdoc />
        public virtual void DoPreview(IStream dataSource)
        {
            this.Visible = true;
        }
