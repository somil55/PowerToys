...
namespace PowerLauncher
{
    public partial class MainWindow : IDisposable
    {
        ...
        private void BringProcessToForeground()
        {
            ...
            WindowsInteropHelper.InteropInput input = new WindowsInteropHelper.InteropInput { type = WindowsInteropHelper.INPUTTYPE.INPUTMOUSE, data = { } };
            WindowsInteropHelper.InteropInput[] inputs = new WindowsInteropHelper.InteropInput[] { input };

            // Send empty mouse event. This makes this thread the last to send input, and hence allows it to pass foreground permission checks
            _ = WindowsInteropHelper.SendInput(1, inputs, WindowsInteropHelper.InteropInput.Size);
            Activate();
        }
